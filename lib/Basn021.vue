...
export default {
  ...
  headers(){
    return[
      {text:'選擇', width:'40px',sortable:false,class:'px-0',cellClass:'px-0',align:'center'},
      {text:'郵遞區號',value:'zipCode', width:'60px',class:'px-0',cellClass:'px-0',align:'center'},
      {text:'郵寄郵遞區號',value:'mailZipcode', width:'60px',class:'px-0',cellClass:'px-0',align:'center'},
      {text:'郵遞區域',value:'zipArea', width:'80px',class:'px-0',cellClass:'px-0',align:'center'}
    ]
  }
  },
  methods:{
